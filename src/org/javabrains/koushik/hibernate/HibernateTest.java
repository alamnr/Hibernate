...
public class HibernateTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * UserDetails user = new UserDetails(); user.setUserName("First User");
		 */
		...
		/*
		 * vehicle.getUsers().add(user); vehicle2.getUsers().add(user);
		 */
		 ...
		 */
		/*
		 * // Table per concrete class with implicit polymorphism CreditCard_1
		 * cc = new CreditCard_1(); cc.setOwner("Khelapi");
		 * cc.setNumber("111-222-333");
		 * 
		 * DebitCard_1 dc = new DebitCard_1(); dc.setOwner("Rin");
		 * dc.setNumber("444-555-666");
		 */
		...
		/*
		 * 
		 * CreditCard_2 cc = new CreditCard_2(); cc.setOwner("Khelapi");
		 * cc.setNumber("111-222-333");
		 * 
		 * DebitCard_2 dc = new DebitCard_2(); dc.setOwner("Rin");
		 * dc.setNumber("444-555-666");
		 */
		// Bidirectional Association (OneToMany and ManyToOne)

		/*
		 * Bid bid = new Bid(); bid.setAmount(30);
		 * 
		 * Bid bid_2 = new Bid(); bid_2.setAmount(130);
		 * 
		 * Item item = new Item();
		 * 
		 * item.setItemName("Laptop"); item.addBid(bid); item.addBid(bid_2);
		 */
		...
		/*
		 * session.save(item); session.save(bid); session.save(bid_2);
		 */
